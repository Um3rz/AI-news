        ...
        <section className="py-20 md:py-28 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 flex items-center justify-center gap-3">
              <Link 
                href="/signup" 
                className="px-6 py-3 rounded-md font-semibold bg-blue-600 text-white hover:bg-blue-700 transition-colors"
              >
                Sign up free
              </Link>
              <Link 
                href="/about" 
                className="px-6 py-3 rounded-md font-semibold border border-gray-800 hover:bg-white/5 transition-colors"
              >
                Learn more
              </Link>
            </div>
